...
import UserNotFound from "shared/ui/notFound/userNotFound";
            ...
            {user?.data.map((user) => (
              ...
              >
                <CardContent className="flex flex-col rounded-sm items-center p-3">
                  ...
                  <Button
                    onClick={() => addFollowRequest({ receiverId: user.id })}
                    className="w-full text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 mt-3 hover:opacity-90 text-sm py-1.5 rounded-md"
                  >
                    Follow
                  </Button>
                </CardContent>
